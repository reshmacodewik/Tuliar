...
import { View, Text, TouchableOpacity, SafeAreaView, ScrollView, Image, StatusBar, ImageBackground } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.peerHeader}>
        ...
        <Text style={styles.peerSubtitle}>
          Choose someone to connect with. Your conversation will be anonymous.
        </Text>
      </View>
      ...
      <View style={styles.filterContainer}>
        <TouchableOpacity style={styles.filterButton}>
          ...
          <MaterialIcons name="arrow-drop-down" size={wp(5)} color="#000" style={styles.filterArrow} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.filterButton}>
            ...
            <View style={styles.peerCardContent}>
              ...
              <View style={styles.peerInfo}>
                ...
                <Text style={styles.peerDescription}>
                  {peer.age} - {peer.gender} - {peer.condition} {peer.description}
                </Text>
