...
const ExploreScreen = () => {
  ...
  const cards = [
    { title: 'Group Sessions', desc: 'Join live group calls on wellness topics.', cta: 'Join Now' },
    { title: 'Therapists', desc: 'Browse our network of wellness professionals', cta: 'Find a Provider' },
    { title: 'Coaches and mentors', desc: 'Browse our network of wellness professionals', cta: 'Find a Provider' },
    { title: 'Tuliar Tools', desc: 'Journal, mood tracker, and more', cta: 'Get Started' },
    { title: 'Special Offers', desc: 'Unlock exclusive group sessions and discounts', cta: 'View Plans' },
  ];
