  ...
  return (
    <SafeAreaView style={sessionDetailsStyles.container}>
      ...
      <View style={sessionDetailsStyles.sessionOverview}>
        <Text style={sessionDetailsStyles.sessionDate}>April 25, 2025 – 2:00 PM</Text>
        <Text style={sessionDetailsStyles.sessionTitle}>Therapy Session with Dr.Smith</Text>
      </View>
      ...
      <View style={sessionDetailsStyles.preparationSection}>
        <Text style={sessionDetailsStyles.preparationHeader}>Prepare for the session</Text>
